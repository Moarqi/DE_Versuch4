...
Nach der Vorlesung und der Informationen im Skript, sollten wir mithilfe der Gate-Source-Spannung den Stromfluss an Drain-Source beeinflussen können.
\subsection*{Aufbau}
\begin{figure}
    \centering
...
\subsection*{Funktionsweise Transistoren} % (fold)
