...
\section*{Auswertung}
Wie sich an \autoref{graphEingangskennlinie} erkennen lässt, liegt die Schwellspannung der Diode bei 1,8V für $U_{GS}$. Im Bereich zwischen 1,8V und 2,2V lässt sich der Triodenbereich erkennen, in welchem wir einen exponentiellen Anstieg der Leitfähigkeit feststellen können. Ab 2,2V befindet sich die Diode dann im Sättigungsbereich. Der Arbeitspunkt liegt im Schnitt der Kennlinie under der Arbeitsgeraden, also an der Stelle auf der Kennlinie, welche mit dem anhängenden Verbraucher übereinstimmt. Daraus lässt sich ablesen, welche Spannung nötig ist, um diesen Verbraucher zu versorgen.

In \autoref{graphAusgangskennlinie} sehen wir zwei Ausgangskurven über der Drain-Source-Spannung, einmal bei festgehaltener Gate-Source-Spannung von 2,5V und einmal 3V. Bei der 2,5V Kurve [BITTE HIER WEITERMACHEN D:::]
